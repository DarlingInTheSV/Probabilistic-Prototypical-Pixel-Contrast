...
from mmseg.apis import multi_gpu_test, single_gpu_test
    # , t_sne_test, draw_uncertainty, calculate_logme, \
    # get_model_complexity, calculate_norm, draw_unlabeled
...
def parse_args():
    ...
    parser.add_argument(
        '--tsne', action='store_true', help='Output Tsne visualization')
...
def main():
    ...
    # if args.tsne:
        # t_sne_test(model1, data_loader)
        # draw_uncertainty(model1, data_loader)
        # calculate_logme(model1, data_loader)
        # calculate_norm(model1, data_loader)
        # get_model_complexity(model1, data_loader)
        # draw_unlabeled(model1, data_loader)
