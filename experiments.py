...
def get_model_base(architecture, backbone):
    ...
    return {
        'dlv3_proj': '_base_/models/deeplabv3_proj_r50-d8.py',
    }[architecture]
...
def generate_experiment_cfgs(id):
    def config_from_vars():
        ...
        if method_name in uda:
            ...
            cfg['model']['auxiliary_head']['loss_decode']['num_queries'] = num_queries
            cfg['model']['auxiliary_head']['loss_decode']['num_negatives'] = num_negatives
            # cfg['model']['auxiliary_head']['loss_decode']['temp1'] = temp
            cfg['model']['auxiliary_head']['loss_decode']['strong_threshold'] = strong_threshold
        ...
        if pmult:
            ...
            opt_param_cfg['uncertain_head'] = dict(lr_mult=1.0)  #
        ...
        cfg['checkpoint_config'] = dict(
            by_epoch=False, interval=2000, max_keep_ckpts=1)
        cfg['evaluation'] = dict(interval=2000, metric='mIoU', save_best='mIoU')
